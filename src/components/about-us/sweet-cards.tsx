    ...
    <>
      <div className="py-20 flex flex-col lg:flex-row flex-wrap xl:flex-nowrap items-center justify-center gap-4 mx-auto px-8">
        ...
        >
          ...
          <div className="absolute inset-0 [mask-image:radial-gradient(400px_at_center,white,transparent)] bg-black/10 dark:bg-black/90" />
        </Card>
        <Card
          title="WELL-BEING"
          icon={<W_Icon />}
...
const S_Icon = () => {
  return (
    <svg
      ...
      fill="none"
      className="h-10 w-10 text-neutral-700 dark:text-rose-200 group-hover/canvas-card:text-white "
    >
...
const W_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-16 text-neutral-700 dark:text-rose-200 group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" fill="currentColor">
...
const E_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-20 text-neutral-700 dark:text-rose-200 group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" fill="currentColor">
        <path
