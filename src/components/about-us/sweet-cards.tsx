...
const S_Icon = () => {
  return (
    <svg
      ...
      fill="none"
      className="h-10 w-10 text-cyan-600 dark:text-rose-400 group-hover/canvas-card:text-white "
    >
...
const W_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-16 text-cyan-600 drop-shadow-md dark:text-rose-400 group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" fill="currentColor">
...
const E_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-20 text-cyan-600 dark:text-rose-400 group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" fill="currentColor">
        <path
