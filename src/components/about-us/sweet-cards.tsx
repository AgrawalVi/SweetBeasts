...
export default function SweetCards() {
  return (
    <>
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-background gap-4 mx-auto px-8">
        <Card
          title="SUPPORT"
          icon={<S_Icon />}
...
const S_Icon = () => {
  return (
    ...
    >
      <g id="svgGroup" stroke="#000" fill="#FFF">
...
const W_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-16 text-black dark:text-white group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" stroke="#000" fill="#FFF">
...
const E_Icon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      className="h-10 w-20 text-black dark:text-white group-hover/canvas-card:text-white "
    >
      <g id="svgGroup" stroke="#000" fill="#FFF">
        <path
