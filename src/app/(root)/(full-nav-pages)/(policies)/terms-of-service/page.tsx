      ...
      <CardContent>
        <div className="text-left">
          ...
          <p className="my-4">
            ...
            supervision. You agree not to use our products for any unlawful or
            unauthorized purpose, and you must comply with all applicable laws,
            including copyright laws, when using the Service. Violation of any
            of these Terms will lead to immediate termination of your access to
            our Services.
          </p>
          ...
          <p className="my-4">
            ...
            transmission across various networks. It may also be adjusted to
            meet technical requirements of connecting networks or devices.
            Please note that credit card information is always encrypted during
            transfer over networks. You agree not to reproduce, duplicate, copy,
            sell, resell, or exploit any part of the Service, use of the
            Service, or access to the Service, or any interaction on the website
            through which the service is provided, without our express written
            permission.
          </p>
          ...
          <p className="my-4">
            ...
            the sole basis for decision-making without consulting more reliable,
            complete, or timely sources of information. Your use of any material
            on this site is at your own risk. This site may include historical
            information that is not current and is provided for reference
            purposes only. We reserve the right to update or modify the content
            on this site at any time, but we are not obligated to do so. You
          ...
          <p className="my-4">
            ...
            you or any third-party for any modifications, price changes,
          ...
          <p className="my-4">
            ...
            made under the same customer account, credit card, or using the same
            billing and/or shipping details. If we modify or cancel an order, we
            will make reasonable efforts to notify you via the email, billing
            address, or phone number provided at the time of purchase. You agree
            to furnish current, accurate, and complete purchase and account
            information for all transactions on our site. It is your
            responsibility to promptly update your account and other details,
            including email addresses, credit card numbers, and expiration
            dates, to facilitate order processing and communication as required.
          ...
          <p className="my-4">
            ...
            and without endorsement. We assume no liability whatsoever arising
            from or related to your use of optional third-party tools. Your use
            of any optional tools provided through the site is entirely at your
            own risk and discretion. It is your responsibility to familiarize
            yourself with and approve of the terms under which these tools are
            provided by the relevant third-party provider(s). Additionally, we
            may introduce new services and features through the website in the
            future, including new tools and resources. These new features and
          ...
          <p className="my-4">
            ...
            We do not oversee or assess the content or accuracy of these
            third-party sites, and we do not guarantee or accept liability for
            any third-party materials, websites, or other products and services.
            We are not responsible for any damages or issues arising from the
            purchase or use of goods, services, resources, or content obtained
            through third-party websites. Before engaging in any transactions,
            please carefully review the policies and practices of these third
            parties. Any concerns or inquiries regarding third-party products
          ...
          <p className="my-4">
            ...
            availability. We retain the right to rectify any errors,
            inaccuracies, or omissions, and to modify or update information or
            cancel orders if any information in the Service or on any associated
            website is inaccurate, without prior notice (including after you
            have placed an order). We are not obligated to update, amend, or
            clarify information in the Service or on any associated website,
            ...
            any related website should not be interpreted as an indication that
          ...
          <p className="my-4">
            ...
            acts; (c) to violate any international, federal, provincial, or
            state regulations, rules, laws, or local ordinances; (d) to infringe
            upon or violate our intellectual property rights or those of others;
            ...
            to provide false or misleading information; (g) to upload or
            transmit viruses or any other type of malicious code that could
            impact the functionality or operation of the Service, related
            websites, or the Internet; (h) to collect or track others' personal
            information; (i) to engage in spamming, phishing, pharming,
            pretexting, spidering, crawling, or scraping; (j) for any obscene or
            immoral purpose; or (k) to interfere with or bypass the security
            features of the Service, related websites, or the Internet. We
          ...
          <p className="my-4">
            ...
            will be accurate or reliable. You acknowledge that from time to time
            we may remove the service for indefinite periods of time or cancel
            the service at any time, without notice to you. You expressly agree
            ...
            through the service are provided 'as is' and 'as available' for your
            use, except as expressly stated by us, without any representation,
            ...
            title, and non-infringement. In no event shall SweetBeasts, our
            ...
            without limitation, lost profits, lost revenue, lost savings, loss
          ...
          <p className="my-4">
            ...
            terminated by either party. You may terminate these Terms of Service
            at any time by notifying us that you no longer wish to use our
            Services or by ceasing to use our site. In our sole discretion, if
            we determine that you have failed to comply with any term or
            provision of these Terms of Service, we may terminate this agreement
            at any time without prior notice. You will remain liable for all
            amounts due up to and including the date of termination, and we may
