...
interface EmailConfirmationEmailProps {
  ...
  export default function EmailConfirmation({ firstName="SweetUser", confirmationLink }: EmailConfirmationEmailProps): JSX.Element {
    return (
      <Html>
        <Head>
            ...
            <Container className="border border-solid border-pink-300 rounded-lg p-6 mx-auto max-w-lg bg-white">
              <Section className="text-center">
                <Img
                  ...
                  width="120"
                />
                <Heading className="text-xl font-bold my-4 text-black">Email Confirmation</Heading>
